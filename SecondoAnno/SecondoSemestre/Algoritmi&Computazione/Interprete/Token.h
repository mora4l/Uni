...
struct Token{ //faccio una struct e non una classe in quanto tutti i metodi sono pubblici , non ce niente di privato e quindi è uguale al fare una classe con solo elementi pubblici
