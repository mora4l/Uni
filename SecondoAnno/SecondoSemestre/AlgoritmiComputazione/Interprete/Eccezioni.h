...
// abbiamo 3 macro categorie di errori che ereditano dalla classe runtime_error :
...
// questa eccezione serve a controllare il programma in caso fosse vuoto (riga 62 lispInterpreter.cpp)
